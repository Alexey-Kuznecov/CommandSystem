...
{
    public class FileListViewModel2 : ObservableObject
    {
        ...
        public string SelectedFileFilter
        {
            ...
            set
            {
                if (SetProperty(ref _selectedFileFilter, value) && FilesView != null)
                    FilesView.Refresh();
            }
        }
        ...
        public string FileSearchText
        {
            ...
            set
            {
                if (SetProperty(ref _fileSearchText, value) && FilesView != null)
                    FilesView.Refresh();
            }
        }

        public FileListViewModel2(ICopyReporter reporter)
        {
